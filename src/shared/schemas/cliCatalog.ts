...
// +5 (cliToolsExtra.ts): aichat, shell-gpt, mods, llm and fabric — terminal
// assistants whose custom-base-URL mechanism was verified against each tool's
// official docs or source before being catalogued.
export const EXPECTED_CODE_COUNT = 27;
...
// +6 (cliToolsExtra.ts): openhands, plandex, gptme, trae, octofriend and raaid.
export const EXPECTED_AGENT_COUNT = 16;
