        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3">
            <Link
              ...
              className="inline-flex items-center rounded-lg bg-blue-600 px-3.5 py-2 text-sm font-medium text-white hover:bg-blue-700 dark:bg-blue-600 dark:hover:bg-blue-500"
            >
              {t("readinessContinue")}
            </Link>
            <button
