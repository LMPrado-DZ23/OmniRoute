  ...
  return (
    <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-2 p-3 bg-surface">
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="text-xs px-2.5 py-1 rounded bg-primary text-on-primary hover:bg-primary/90 transition-colors"
                      >
                        {t("save")}
                      </button>
                      <button
      ...
      <div className="border border-border rounded-lg p-3 flex flex-col gap-2 bg-surface">
        ...
        <button
          onClick={handleAdd}
          className="text-xs px-3 py-1.5 rounded bg-primary text-on-primary hover:bg-primary/90 transition-colors self-start"
        >
          + {t("addTool")}
        </button>
      </div>
