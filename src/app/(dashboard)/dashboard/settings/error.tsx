  ...
  return (
    ...
    >
      <div className="text-center space-y-4">
        ...
        <button
          onClick={reset}
          className="px-4 py-2 bg-primary text-on-primary rounded-lg hover:bg-primary-hover transition-colors focus:outline-2 focus:outline-offset-2 focus:outline-primary"
        >
          {t("errorPage.retry")}
        </button>
      </div>
